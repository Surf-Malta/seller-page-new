...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen pt-[72px]">
        ...
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-[0.9rem] text-text-2 text-center">Customers search for your products and buy directly through the Surf app or website, reaching shoppers already looking for what you sell.</p>
            </div>
            {/* Step 2 */}
            <div className="flex flex-col gap-4">
              <div className="aspect-square bg-grey rounded-[20px] overflow-hidden">
              ...
              <p className="text-[0.9rem] text-text-2 text-center">Get notified instantly and manage every order from the Surf Seller Hub app. accept, prepare, and update from anywhere, right from your phone.</p>
            </div>
            {/* Step 3 */}
            <div className="flex flex-col gap-4">
              <div className="aspect-square bg-grey rounded-[20px] overflow-hidden">
              ...
              <p className="text-[0.9rem] text-text-2 text-center">Use your own couriers and Surf covers the delivery cost or let us handle it entirely. Surf's logistics partner collects directly from your store and delivers to your customer's door.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-6 md:py-10 bg-brand-gradient overflow-hidden">
        <div className="max-w-[1440px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-[1.1fr_1fr] gap-12 items-center">
            ...
            <div className="relative w-full ml-4 md:ml-8 lg:ml-12 overflow-hidden">
              <img
            ...
            {/* Right Side: Content */}
            <div className="flex flex-col items-start text-left p-8 md:p-12 lg:p-16 md:pl-16 lg:pl-24">
        ...
        <div className="max-w-[1024px] mx-auto flex flex-wrap items-center gap-[32px] justify-between">
            ...
            <div className="flex flex-wrap items-center gap-4 mt-8">
              ...
              <div className="relative">
                <img
                  ...
                  alt="App Store"
                  className="h-[60px] w-auto block opacity-40 grayscale"
                />
          ...
          <div className="flex-1 min-w-[280px] flex justify-center lg:justify-end">
            <img
              ...
              alt="Seller Hub app"
              className="w-full max-w-[420px] h-[600px] rounded-[20px] block shadow-none"
            />
          </div>
        </div>
      </section>
      ...
      {/* FINAL CTA SECTION */}
      <section className="py-6 md:py-10 px-8 bg-seller-gradient">
        <div className="max-w-[1280px] mx-auto">
          <div className="p-[28px_48px] rounded-[32px] flex flex-col md:flex-row items-center justify-between gap-8 group">
            <div>
