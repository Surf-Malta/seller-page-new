    ...
    >
      <div className="w-full max-w-[1280px] mx-auto px-6 md:px-8 flex items-center justify-between gap-4">
        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          <Link
            href="#"
            className="px-5.5 py-2.5 rounded-full border-none bg-black text-sm font-semibold text-white hover:bg-[#333] transition-all no-underline inline-flex items-center"
          >
            Start for free
          </Link>
        </div>
          ...
          >
            <div className="p-4 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Link
                  href="#"
                  className="w-full text-center py-3.5 rounded-full bg-black text-white font-semibold text-sm no-underline"
                >
                  Start for free
                </Link>
              </div>
